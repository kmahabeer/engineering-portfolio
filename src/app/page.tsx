  ...
  return (
    <main>
      <div className="richtext mx-auto md:max-w-xl lg:max-w-none">
        ...
        <p>
          My name is Kevin Mahabeer. I&apos;m an Electrical Engineering graduate
          from Drexel University. Through experiences interning at NASA Goddard
          Space Flight Center and working at General Dynamics Electric Boat,
          I&apos;ve worked hard to refine my skills in MATLAB, analog and
        ...
        <p>
          If you&apos;re interested, you can find the source code repository for
